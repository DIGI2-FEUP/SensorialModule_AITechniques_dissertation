...
'''
Iteration 3 - Plot of predictions
'''
...
# plt.figure()
# plt.clf()
# ax = plt.scatter(data["temp"], data["blue"])
# plt.ylabel("blue")
# plt.xlabel("temp")
# plt.savefig("../4_figures/blue_temp.png")
#
# plt.figure()
# plt.clf()
# ax = plt.scatter(data["pH"], data["blue"])
# plt.ylabel("blue")
# plt.xlabel("pH")
# plt.savefig("../4_figures/blue_pH.png")
...
plt.clf()
# Create a line plot with both y_test and y_pred
plt.plot(indexes, y_test, label="True Values", marker='o')
plt.plot(indexes, y_pred, label="Predicted Values", marker='x')
dif = y_pred - y_test
# plt.plot(indexes, dif, label="Difference Pred - Test", marker='D')
plt.xlabel("Index")
plt.ylabel("Values")
plt.legend()
plt.title(f"KNN; RMSE = {rmse:.2f}")
plt.savefig("../4_figures/KNN Predictions")
...
plt.savefig("../4_figures/Linear Predictions")
...
plt.savefig("../4_figures/Random Forest Predictions")
